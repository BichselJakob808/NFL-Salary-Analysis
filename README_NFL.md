...
git clone https://github.com/yourusername/nfl-salary-analysis
...
This will generate `nfl_salary_analysis.png` — the 4-panel visualization dashboard.
...
```
nfl-salary-analysis/
├── nfl_salary_analysis.py    # Main analysis script
├── nfl_2024_performance.csv  # Dataset
├── nfl_salary_analysis.png   # Output visualization
└── README.md
```
...
- Expand dataset to all 32 teams and all position groups including offensive and defensive linemen
- Add a regression line to the scatter plot to quantify the salary-performance relationship
- Pull live data from the nflverse public API to make the dataset updateable each season
- Build an interactive Plotly or Tableau version of the dashboard

---

## Data Sources

- Salary/cap hit data: OverTheCap (2024 season)
- Performance stats: Pro Football Reference (2024 regular season)
